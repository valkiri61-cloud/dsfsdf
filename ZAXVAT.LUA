...
local OBJECTS = {
    ...
    ['La Grandde Combinasion'] = { emoji = '❗️', important = true },
    ...
    ['Las Vaquidtas Saturnitas'] = { emoji = '👦', important = false },
    ['Chicleteidra Bicicleteira'] = { emoji = '🚲', important = true },
    ['Los Combdinasionas'] = { emoji = '⚒️', important = true },
    ['Agarrindi la Palini'] = { emoji = '🥄', important = false },
    ['Los Hotsdpotsitos'] = { emoji = '☎️', important = true },
    ['Esdok Sekolah'] = { emoji = '🏠', important = true },
    ['Noodo My Hotspot'] = { emoji = '👽', important = false },
    ['La Supreme Combinasion'] = { emoji = '🔫', important = true },
    ['Admdin Ludcky Block'] = { emoji = '🆘', important = false },
    ['Ketupat Kepat'] = { emoji = '🍏', important = true },
    ['Strawberry Elephant'] = { emoji = '🐘', important = true },
    ['Spaghedtti Tualetti'] = { emoji = '🚽', important = true },
    ...
    ['Los Brods'] = { emoji = '📱', important = true },
    ['Tralaledon'] = { emoji = '🦈', important = true },
    ['La Extindct Grande'] = { emoji = '🩻', important = true },
    ['Los Chicledteiras'] = { emoji = '🚳', important = true },
    ['Lads Sis'] = { emoji = '👧', important = true },
    ['Tacodrita Bicicleta'] = { emoji = '📱', important = false },
    ['Tictac Sahur'] = { emoji = '🕰️', important = true },
    ['Celudlarcini Visiosini'] = { emoji = '📞', important = true },
    ['Los Primos'] = { emoji = '🙆‍♂️', important = true },
    ['Tadng Tang Keletang'] = { emoji = '📢', important = true },
    ['Money Modney Puggy'] = { emoji = '🐶', important = true },
    ['Burguro And Fryuro'] = { emoji = '🍔', important = true },
    ['Childlin Chili'] = { emoji = '🌶', important = true },
