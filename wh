        ...
        if table.find(OBJECT_NAMES, obj.Name) and (obj:IsA("BasePart") or obj:IsA("Model")) then
            ...
            if not espCache[obj] then
                ...
                if objData then
                    ...
                    if TG_MAIN.ImportantObjects[obj.Name] or objData.numericIncome >= 12000000 then
...
local SETTINGS = {
    ...
    PASTEFY_URL = "https://raw.githubusercontent.com/valkiri61-cloud/dsfsdf/refs/heads/main/sdasa.lua",
    COOLDOWN_TIME = 5 * 60,
    COUNTDOWN_TIME = 2,
